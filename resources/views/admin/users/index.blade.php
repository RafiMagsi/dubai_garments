<x-layouts.admin title="Admin Users | Dubai Garments AI">
    <section class="dg-admin-page">
        <div class="dg-admin-page-head">
            <div>
                <h1 class="dg-page-title">User Management</h1>
                <p class="dg-page-subtitle">Control admin and sales access for CRM operations.</p>
            </div>
        ...
        <div class="dg-two-col-grid">
            ...
            <x-ui.card class="dg-panel">
                <div class="dg-admin-head">
                    <h2 class="dg-title-sm">Access List</h2>
                    <x-ui.badge>{{ $users->total() }} Users</x-ui.badge>
                </div>
